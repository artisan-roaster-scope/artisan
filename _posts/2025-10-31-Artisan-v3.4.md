...
- **Captured BBP Metrics**   
Roast operators employ a Between Batch Protocol (BBP) to insure every roast batch begins with the same thermal state. This version captures metrics to help the roast operator observe and manage their BBP. For details, refer to our separate post on [Between Batch Protocol Statistics](https://artisan-roasterscope.blogspot.com/2025/11/between-batch-protocol-statistics.html){:target="_blank"}.
