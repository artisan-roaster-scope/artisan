...
**Watch out!** 
To connect successfully, Artisan running on Windows requires the **[Aillio USB Drivers For Legacy Version Only](https://aillio.com/?page_id=18556)** `libusb-win32-bin-1.2.6.0.exe`, to be installed (see under Downloads).
{: .notice--primary}
