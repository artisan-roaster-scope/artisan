...
On a MAC, you will get a warning that Artisan is from an unidentified developer.  That is being worked on but go to Settings>Security and Privacy, and you will be able to allow Artisan to install.  
...
More complete instructions on the [installations page](/_docs/02-installation.md).
