...
#   
#brew upgrade python
HOMEBREW_NO_AUTO_UPDATE=1 brew install python@3.7.4
#HOMEBREW_NO_AUTO_UPDATE=1 brew install https://raw.githubusercontent.com/Homebrew/homebrew-core/COMMIT_IDENTIFIER/Formula/python.rb
