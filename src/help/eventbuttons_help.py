...
def content():
    ...
    tbl_Commandstop.add_row([QApplication.translate('HelpDlg','Note: "{}" can be used as a placeholder, it will be subsituted by the current button value plus the offset for \u00B1 event types.  If a placeholder occurs several times in a description/command, all those occurrences are replaced by the value.',None)])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','Modbus',None),QApplication.translate('HelpDlg','_',None),QApplication.translate('HelpDlg','variable holding the last value read via MODBUS',None)])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','Fuji',None),QApplication.translate('HelpDlg','write(<unitId>,<register>,<value>)',None),'&#160;'])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','Artisan',None),QApplication.translate('HelpDlg','alarms(<bool>)',None),QApplication.translate('HelpDlg','enables/disables alarms',None)])
