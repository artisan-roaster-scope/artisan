...
def content() -> str:
    ...
    tbl_Options.add_row([QApplication.translate('HelpDlg','Button size'),QApplication.translate('HelpDlg','Sets a size for the buttons.  Choices are tiny, small, large and xlarge.')])
