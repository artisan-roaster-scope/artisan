...
def content():
    ...
    tbl_Options.add_row([QApplication.translate('HelpDlg','Tooltips'),QApplication.translate('HelpDlg','Show button specification as tooltips on hoovering a button')])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','IO Command'),'^',QApplication.translate('HelpDlg','variable holding the last state of the button pressed (1 or 0)')])
