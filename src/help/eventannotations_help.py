...
def content():
    ...
    tbl_Annotations.add_row(['~R1',QApplication.translate('HelpDlg','ET RoR value',None),10])
    tbl_Annotations.add_row(['~R2',QApplication.translate('HelpDlg','BT RoR value',None),12])
