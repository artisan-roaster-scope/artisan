...
def content():
    ...
    tbl_Annotations.add_row(['~descr',QApplication.translate('HelpDlg','The Description field of the Event',None),QApplication.translate('HelpDlg','Gas 10',None)])
    tbl_Annotations.add_row(['~type',QApplication.translate('HelpDlg','The Type field of the Event',None),QApplication.translate('HelpDlg','Power',None)])
    tbl_Annotations.add_row(['~sldrunit',QApplication.translate('HelpDlg','The value of the Slider Unit for this Event',None),QApplication.translate('HelpDlg','kPa',None)])
    ...
    tbl_Notes.add_row([QApplication.translate('HelpDlg','When annotations overlap to the oint they can not be read, try reducing the value of the &#39;Allowed Annotation Overlap&#39; found on the Annotations configuration page.  The default value for this etting is 100%.',None)])
