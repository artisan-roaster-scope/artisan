...
def content():
    ...
    tbl_Examples.add_row([QApplication.translate('HelpDlg','~title ~weight~weightunits ~finishphase_deltatemp~mode'),QApplication.translate('HelpDlg','Burundi 454.0g 19.8F.alog')])
