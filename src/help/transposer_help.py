...
def content():
    ...
    strlist.append("<b>")
    strlist.append(QApplication.translate('HelpDlg','TRANSPOSER',None))
    strlist.append("</b>")
    ...
    strlist.append(QApplication.translate('HelpDlg','EXAMPLE 1: ADJUST TOTAL ROAST TIME',None))
    strlist.append("</b>")
    ...
    strlist.append("<br/><br/><b>")
    strlist.append(QApplication.translate('HelpDlg','EXAMPLE 2: MAP BETWEEN TWO ROASTING MACHINES',None))
    strlist.append("</b>")
