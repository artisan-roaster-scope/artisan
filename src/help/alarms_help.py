...
def content() -> str:
    ...
    tbl_Actions.add_row([QApplication.translate('HelpDlg','Event Button'),QApplication.translate('HelpDlg','<button number>[><value>],..,<button number>[><value>]'),QApplication.translate('HelpDlg','triggers the button optional overwriting the button value with <value> (eg. ‘1>10,2,3>100’); the button number comes from the Events Buttons configuration')])
