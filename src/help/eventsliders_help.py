...
def content() -> str:
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','Stepper Command'),'set(ch,pos[,sn])',QApplication.translate('HelpDlg','for PHIDGET Bipolar Stepper Motors: set the target position ')])
    tbl_Commands.add_row(['&#160;','rescale(ch,val[,sn])',QApplication.translate('HelpDlg','for PHIDGET Setepper Bipolar Stepper Motors: set the rescale factor')])
    tbl_Commands.add_row(['&#160;','engaged(ch,b[,sn])',QApplication.translate('HelpDlg','for PHIDGET Setepper Bipolar Stepper Motors:  engage (b=1) or disengage (b = 0)')])
