...
def content() -> str:
    ...
    tbl_Commands.add_row(['&#160;','skywalker(<command>,<value>)',QApplication.translate('HelpDlg','sends the raw TC4 <command>,<value> to the Skywalker (Cyberroaster) via BLE'),'&#160;']) ## CYBER ##
    tbl_Commands.add_row(['&#160;','skycommand(<command>,<value>)',QApplication.translate('HelpDlg','sends the raw TC4 <command>,<value> to the Skycommand (Cyberroaster) via BLE'),'&#160;']) ## SKYBLE ##
