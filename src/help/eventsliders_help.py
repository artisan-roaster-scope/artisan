...
def content():
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','showCurve(<name>,<bool>)',None),QApplication.translate('HelpDlg','shows/hides the curve indicated by <name> which is one of { ET, BT, DeltaET, DeltaBT, BackgroundET, BackgroundBT}',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','showExtraCurve(<extra_device>,<curve>,<bool>)',None),QApplication.translate('HelpDlg','shows/hides the <curve> (one of {T1,T2}) of the zero-based <extra_device> number',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','showEvents(<event_type>, <bool>)',None),QApplication.translate('HelpDlg','shows/hides the events of <event_type> in [1,..,5]',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','showBackgroundEvents(<bool>)',None),QApplication.translate('HelpDlg','shows/hides the events of the background profile',None)])
