...
def content():
    ...
    tbl_Commandstop.add_row([QApplication.translate('HelpDlg','Note: "{}" can be used as a placeholder, it will be subsituted by (value*factor + offset).',None)])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','PWM',None),QApplication.translate('HelpDlg','out(<channel>,<value>[,<sn>])',None),QApplication.translate('HelpDlg','PHIDGET PWM Output: <value> in [0-100], <sn> : has the form <hub_serial>[:<hub_port>], an optional serial number of the hub, optionally specifying the port number the module is connected to',None)])
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','outhub(<channel>,<value>[,<sn>])',None),QApplication.translate('HelpDlg','PHIDGET HUB PWM Output: <value> in [0-100], <sn> : has the form <hub_serial>[:<hub_port>], an optional serial number of the hub, optionally specifying the port number the module is connected to',None)])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','VOUT',None),QApplication.translate('HelpDlg','out(<n>,<v>[,<sn>])',None),QApplication.translate('HelpDlg','for PHIDGET OUTPUT modules: set analog output channel n to output voltage value v in V (eg. 5.5 for 5.5V) on a Phidget, <sn> : has the form <hub_serial>[:<hub_port>], an optional serial number of the hub',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','vout(c,v[,sn])',None),QApplication.translate('HelpDlg','for YOCTOPUCE VOLTAGE OUT modules with c the channel (1 or 2),v the voltage as float [0.0-10.0] and the optional sn either the modules serial number or its name',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','cout(c[,sn])',None),QApplication.translate('HelpDlg','for YOCTOPUCE CURRENT OUT modules with c the current as float [3.0-21.0] and the optional sn either the modules serial number or its name',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','sleep(<float>)',None),QApplication.translate('HelpDlg','sleep: add a delay of <float> seconds',None)])
    tbl_Commands.add_row([QApplication.translate('HelpDlg','IO',None),QApplication.translate('HelpDlg','set(c,b[,sn])',None),QApplication.translate('HelpDlg','PHIDGET Binary Output: switches channel c off (b=0) and on (b=1)',None)])
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','sleep(<float>)',None),QApplication.translate('HelpDlg','sleep: add a delay of <float> seconds',None)])
    tbl_Commands.add_row([QApplication.translate('HelpDlg','S7',None),QApplication.translate('HelpDlg','getDBint(<dbnumber>,<start>)',None),QApplication.translate('HelpDlg','read int from S7 DB',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','getDBfloat(<dbnumber>,<start>)',None),QApplication.translate('HelpDlg','read fl oat from S7 DB',None)])
    ...
    tbl_Commands.add_row([QApplication.translate('HelpDlg','RC',None),QApplication.translate('HelpDlg','pulse(ch,min,max[,sn])',None),QApplication.translate('HelpDlg','for PHIDGET RC modules: sets the min/max pulse width in microseconds. sn : has the form <hub_serial>[:<hub_port>], an optional serial number of the hub, optionally specifying the port number the module is connected to',None)])
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','enabled(c,b[,sn])',None),QApplication.translate('HelpDlg','for YOCTOPUCE RC modules: with c:int the channel, b a bool (eg. enabled(0,1) or enabled(0,True)), sn the optional modules serial number or logical name',None)])
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','neutral(c,n[,sn])',None),QApplication.translate('HelpDlg','for YOCTOPUCE RC modules: with n an int [0..65000] in us, sn the modules serial number or logical name',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','range(c,r[,sn])',None),QApplication.translate('HelpDlg','for YOCTOPUCE RC modules: with r an int in %, sn the modules serial number or logical name',None)])
