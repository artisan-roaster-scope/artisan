...
def content():
    ...
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','pidSV(<float>)',None),QApplication.translate('HelpDlg','sets the PID target set value SV',None)])
    tbl_Commands.add_row(['&#160;',QApplication.translate('HelpDlg','pidRS(<int>)',None),QApplication.translate('HelpDlg','activates the PID Ramp-Soak pattern number <n> (1-based!)',None)])
