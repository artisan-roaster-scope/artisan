...
def content() -> str:
    ...
    tbl_KeyboardShortcuts.add_row([';\nExpert and Standard modes',QApplication.translate('HelpDlg','Application ScreenShot')])
    tbl_KeyboardShortcuts.add_row([':\nExpert and Standard modes',QApplication.translate('HelpDlg','Desktop ScreenShot')])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Click on timer\nExpert mode'),QApplication.translate('HelpDlg','Simulator'),QApplication.translate('HelpDlg','Toggle Pause/Continue Simulation'),QApplication.translate('HelpDlg','Simulator speed may be changed while paused (hold shift  (1x), OPTION/ALT (2x) or COMMAND/CTRL (4x) on restart).')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','OPTION Tools>>Simulator [Mac]\nALT Tools>>Simulator [Win]\nExpert mode'),QApplication.translate('HelpDlg','Graph/Simulator\n[Expert mode]'),QApplication.translate('HelpDlg','Start or change Simulator speed to 2x mode'),'&#160;'])
    ...
    tbl_MenuShortcuts.add_row(['⌘+W [Mac]\nCTRL+F4 [Win]\nExpert and Standard modes',QApplication.translate('HelpDlg','Roast'),QApplication.translate('HelpDlg','Switch Profiles (Foreground<=>Background)')])
    tbl_MenuShortcuts.add_row(['⌘+D [Mac]\nCTRL+D [Win]\nExpert mode only',QApplication.translate('HelpDlg','Config'),QApplication.translate('HelpDlg','Open Devices dialog')])
    tbl_MenuShortcuts.add_row(['⌘+U [Mac]\nCTRL+U [Win]\nExpert mode only',QApplication.translate('HelpDlg','Config'),QApplication.translate('HelpDlg','Open Curves dialog')])
    tbl_MenuShortcuts.add_row(['⌘+E [Mac]\nCTRL+E [Win]\nExpert and Standard modes',QApplication.translate('HelpDlg','Config'),QApplication.translate('HelpDlg','Open Events dialog')])
    tbl_MenuShortcuts.add_row(['⌘+A [Mac]\nCTRL+A [Win]\nExpert and Standard modes',QApplication.translate('HelpDlg','Config'),QApplication.translate('HelpDlg','Open Alarms dialog')])
    tbl_MenuShortcuts.add_row(['⌘+SHIFT+A [Mac]\nCTRL+SHIFT+A [Win]\nExpert and Standard modes',QApplication.translate('HelpDlg','Config'),QApplication.translate('HelpDlg','Open Axes dialog')])
    tbl_MenuShortcuts.add_row(['⌘+K [Mac]\nCTRL+K [Win]\nExpert mode only',QApplication.translate('HelpDlg','Tools'),QApplication.translate('HelpDlg','Analyzer Auto All')])
    tbl_MenuShortcuts.add_row(['⌘+OPTION+A [Mac]\nCTRL+ALT+K [Win]\nExpert mode only',QApplication.translate('HelpDlg','Tools'),QApplication.translate('HelpDlg','Analyzer Clear Results')])
