...
def content() -> str:
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','OPTION click on Background Profile Title  [Mac]\nALT click on Background Profile Title [Win]'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Toggle Playback Events'),QApplication.translate('HelpDlg','Only when a Background profile is loaded')])
