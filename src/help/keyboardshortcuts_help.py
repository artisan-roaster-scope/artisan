...
def content():
    ...
    tbl_KeyboardShortcuts.add_row([QApplication.translate('HelpDlg','LEFT,RIGHT'),QApplication.translate('HelpDlg','Change roast event key focus')])
    tbl_KeyboardShortcuts.add_row([QApplication.translate('HelpDlg','LEFT,RIGHT,UP,DOWN'),QApplication.translate('HelpDlg','Move background (when sliders not visible or when Config>> Events>> Sliders tab>> Keyboard Control is not selected)')])
