...
def content():
    ...
    tbl_KeyboardShortcuts.add_row(['COMMAND-N\u00A0\u00A0\u00A0[Windows: CRTL+N]',QApplication.translate('HelpDlg','Autosave + Reset + START')])
    ...
    tbl_KeyboardShortcuts.add_row(['OPTION+h\u00A0\u00A0\u00A0[Windows: CTRL+SHIFT+h]',QApplication.translate('HelpDlg','Remove background profile')])
    ...
    tbl_KeyboardShortcuts.add_row(['COMMAND 0-9\u00A0\u00A0\u00A0[Windows: CRTL 0-9]',QApplication.translate('HelpDlg','Changes Event Button Palettes')])
