...
더 작은 기계에 기록된 프로필을 로드하고 트랜스포저를 엽니다. 선형 매핑을 선택하고 더 큰 기계에서 관찰된 DRY 및 FC START 목표 온도를 BT 아래의 해당 필드에 입력합니다. 표 아래에 계산된 기호 공식이 표시되며 구성 &gt;&gt; 장치 아래의 BT 기호 공식에 복사하여 붙여넣을 수 있습니다. 소형 머신에서 로스팅하는 동안 계산된 매핑을 자동으로 조정하여 대형 머신에서 예상한 온도 판독값을 확인합니다. .</translation>
    ...
    <message>
      ...
      <translation>참고: 자리 표시자 {ET}, {BT}, {time}, {ETB}, {BTB}, {WEIGHTin} 및 {TEMP}는 현재 ET, BT, 시간, ET 배경, BT 배경 값, 배치 크기(g), Serial/Artisan/CallProgram/MODBUS/S7/WebSocket 명령에서 현재 온도 단위로 변환된 F 단위의 이벤트 값으로 대체됩니다.
</translation>
    </message>
    <message>
      <location filename="../help/eventsliders_help.py" line="34"/>
...
플로터에서 수학 공식을 사용하면 기호 변수 P 및 F도 사용할 수 있습니다(신호, 기호 할당 및 플로터 참조).</translation>
    ...
    <message>
      ...
      <translation type="vanished">참고: 자리 표시자 {ET}, {BT}, {time}, {ETB}, {BTB} 및 {WEIGHTin}은 현재 ET, BT, 시간, ET 배경, BT 배경 값 및 배치 크기로 대체됩니다. (ing) Serial/Artisan/CallProgram/MODBUS/S7/WebSocket 명령
</translation>
    </message>
    <message>
      <source>Note: The placeholders {ET}, {BT}, {time}, {ETB}, {BTB}, and {WEIGHTin} will be substituted by the current ET, BT, time, ET background, BT background value and batch size (in g) in Serial/Artisan/CallProgram/MODBUS/S7/WebSocket commands
