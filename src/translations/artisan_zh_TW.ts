...
當鍵盤快捷鍵關閉時添加自定義事件</translation>
    ...
    <message>
      ...
      <translation>快速特殊活動輸入。 q、w、e 和 r 鍵對應特殊事件 1、2、3 和 4。快速鍵字母後面必須有兩位數字值，例如： “q75”，當對應的事件滑桿最大值為 100 或更小時（預設）。當滑桿最大值大於 100 時，必須輸入三位數字，對於小於 100 的值，需要輸入前導零，例如“q075”。</translation>
    </message>
    <message>
