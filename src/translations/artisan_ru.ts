...
охлаждение</translation>
    ...
    <message>
        ...
        <translation>TA612C(): получено {0} байт, но требуется 13</translation>
    </message>
    <message>
...
Аварийные сигналы сканируются в порядке от верха таблицы к низу.</translation>
    ...
    <message>
        ...
        <translation>&lt;номер кнопки&gt;[&gt;&lt;значение&gt;],..,&lt;номер кнопки&gt;[&gt;&lt;значение&gt;]</translation>
    </message>
    <message>
        <location filename="../help/alarms_help.py" line="64" />
        ...
        <translation>активирует кнопку, опционально перезаписывая значение кнопки на &lt;value&gt; (например, «1&gt;10,2,3&gt;100»); номер кнопки берется из конфигурации кнопок событий</translation>
    </message>
    <message>
...
Загрузите профиль, записанный на меньшей машине, и откройте Transposer. Выберите линейное отображение и введите целевые температуры DRY и FC START, наблюдаемые на вашей более крупной машине, в соответствующие поля в разделе BT. Под таблицей вы видите вычисленную символическую формулу, которую можно скопировать и вставить в символическую формулу BT в разделе «Конфигурация» &gt;&gt; «Устройства» для автоматической настройки вычисленного сопоставления во время обжаривания на вашей меньшей машине, чтобы увидеть показания температуры, как вы ожидаете, на большей машине. .</translation>
    ...
    <message>
        ...
        <translation>Считывает регистр устройства deviceID с помощью функции 3 (Чтение нескольких регистров хранения). Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает один 16-битный регистр с устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя его как знаковое целое число. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает один 16-битный регистр с устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя её как двоично-десятичное число. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает два 16-битных регистра из устройства deviceID с помощью функции 3 (Чтение нескольких регистров хранения), интерпретируя их как беззнаковое целое число. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает два 16-битных регистра с устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя их как знаковое целое число. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает два 16-битных регистра из устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя их как двоично-десятичные данные. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>Считывает два 16-битных регистра из устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя её как число с плавающей точкой. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        ...
        <translation>УСТАРЕЛО: используйте writeSingle для функции MODBUS 6 (целое число) или writeWord для функции 16 (плавающее число)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Регистр записи маски: функция MODBUS 22 или имитирует функцию 22 с функцией 6 и заданным значением</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>записать 16-битное значение в кодировке BCD в регистр устройства с идентификатором устройства</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>включает разъем Shelly номер &lt;n&gt;, если b равно true или 1, и выключает в противном случае</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>устанавливает бета- и гамма-параметры ПИД</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>устанавливает опережающий просмотр PID в секундах</translation>
    </message>
    <message>
        ...
        <translation>устанавливает прогнозируемый повтор событий Ramping в секундах</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>показать/скрыть ползунок для каждого типа события n из {1,2,3,4}</translation>
    </message>
    <message>
...
Inputs with the device id set to 0 are turned off.</source>
        <translation>Входы 1+2 настраивают устройство MODBUS, входы 3+4 настраивают устройство MODBUS_34 и т. д.
Входы с идентификатором устройства, равным 0, отключены.</translation>
    </message>
    <message>
...
Функция 4 (чтение входных регистров): регистры от 0 до 65535, соответствующие номерам от 300001 до 365536.</translation>
    ...
    <message>
        ...
        <translation>Диалоговое окно «ПИД-регулирование» позволяет управлять подключенным ПИД-регулятором, используя заданные регистры ПИД-регулятора для настройки параметров ПИД-регулятора и заданного значения (SV). Для включения и выключения ПИД-регулятора из этого диалогового окна можно использовать команды MODBUS. Информация о доступных командах записи MODBUS представлена на странице справки в диалоговом окне «События».</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Считывает один 16-битный регистр с устройства deviceID, используя функцию 3 (Чтение нескольких регистров хранения), интерпретируя его как беззнаковое целое число. Результат привязывается к заполнителю `_` и, таким образом, может быть доступен в последующих командах.</translation>
    </message>
    <message>
        <location filename="../help/eventbuttons_help.py" line="119" />
        <source>write 16bit BCD encoded value to register of device with DeviceID </source>
        <translation>записать 16-битное значение в кодировке BCD в регистр устройства с DeviceID</translation>
    </message>
    <message>
        <location filename="../help/eventbuttons_help.py" line="123" />
...
Входы с областью, установленной на пустой вход, отключаются.</translation>
    ...
    <message>
        ...
        <translation>Диалоговое окно «ПИД-регулирование» позволяет управлять подключенным ПИД-регулятором, используя заданные регистры ПИД-регулятора для установки параметров ПИД-регулятора и заданного значения (SV). Для включения и выключения ПИД-регулятора из этого диалогового окна можно использовать команды S7. Информация о доступных командах записи S7 представлена на странице справки в диалоговом окне «События».</translation>
    </message>
    <message>
...
Из «Обжарка»&gt; «Свойства»&gt; «Примечания к каппингу»</translation>
    ...
    <message>
        ...
        <translation>Примечание: все символьные переменные чувствительны к регистру!</translation>
    </message>
    <message>
        <location filename="../help/symbolic_help.py" line="192" />
...
(см. ниже)</translation>
    ...
    <message>
        ...
        <translation>Скорость роста ET (сглаженная)</translation>
    </message>
    <message>
        <location filename="../help/symbolic_help.py" line="50" />
        <source>BT rate of rise  (smoothed)</source>
        <translation>Темпы роста BT (сглаженные)</translation>
    </message>
    <message>
        <location filename="../help/symbolic_help.py" line="51" />
        <source>Background ET rate of rise  (smoothed)</source>
        <translation>Скорость роста фонового ET (сглаженная)</translation>
    </message>
    <message>
        <location filename="../help/symbolic_help.py" line="52" />
        <source>Background BT rate of rise  (smoothed)</source>
        <translation>Скорость роста фонового БТ (сглаженная)</translation>
    </message>
    <message>
        ...
        <translation>Примечание: Сглаживание обычно применяется ко всем дополнительным устройствам. Сглаживание не применяется, когда символическое уравнение дополнительного устройства включает переменную скорости роста (R1, R2, RB1 или RB2). Переменные скорости роста уже имеют сглаживание.</translation>
    </message>
    <message>
...
Использование математических формул в плоттере также позволяет использовать символьные переменные P и F (см. Сигналы, символические назначения и плоттер).</translation>
    ...
    <message>
        ...
        <translation type="vanished">&lt;номер кнопки&gt;</translation>
    </message>
    <message>
        <source>triggers the button, the button number comes from the Events Buttons configuration</source>
        <translation type="vanished">запускает кнопку, номер кнопки берется из конфигурации кнопок событий</translation>
    </message>
    <message>
        <source>sets the PID lookahead</source>
        <translation type="vanished">устанавливает предварительный просмотр PID</translation>
    </message>
</context><context>
    <name>Label</name>
    <message>
...
ЖК-дисплеи Все</translation>
    ...
    <message>
        ...
        <translation>Выберите способ преобразования профиля</translation>
    </message>
    <message>
...
Fewer nodes: simpler curve but may lose detail</source>
        <translation>Больше узлов: лучшее соответствие, но сложнее редактирование.
Меньше узлов: более простая кривая, но возможна потеря деталей.</translation>
    </message>
    <message>
        <location filename="../artisanlib/dialogs.py" line="792" />
        <source>Number of spline nodes</source>
        <translation>Количество узлов сплайна</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Масштабные ЖК-дисплеи</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ИКАВА CSV...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Петрончини CSV...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Рубейз CSV...</translation>
    </message>
    <message>
...
Повторить операцию в конце: {0}</translation>
    ...
    <message>
        ...
        <translation>Ошибка записи значения PID RS {0}</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Новое дополнительное устройство: виртуальное: y1(x) =[{}]; y2(x)=[{}]</translation>
    </message>
    <message>
...
Чтобы он оставался бесплатным и актуальным, поддержите нас своим пожертвованием и подпишитесь на artisan.plus, чтобы скрыть этот диалог!</translation>
    ...
    <message>
        ...
        <translation>Не удалось переключить ({})</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Команда ввода-вывода {}] неизвестна</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Повторить просмотр вперед: {0}</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Режим автоматического построения осей графика отключен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Файл Artisan JSON успешно сохранен</translation>
    </message>
    <message>
        <location filename="../artisanlib/main.py" line="14252" />
...
Рекомендуется заранее сохранить текущие настройки через меню «Справка» &gt;&gt; «Сохранить настройки».</translation>
    ...
    <message>
        ...
        <translation>Импорт JSON-адреса HiBean</translation>
    </message>
    <message>
...
В профиле отсутствует [загрузка] или [выброс]</translation>
    ...
    <message>
        ...
        <translation type="vanished">Импорт URL-адреса RoastPATH</translation>
    </message>
    <message>
...
Continue?</source>
        <translation type="vanished">Импорт профиля в Designer уничтожит все данные, кроме основных [точек].
Продолжать?</translation>
    ...
    <message>
        ...
        <translation type="vanished">Весы Bluetooth не могут быть подключены, пока разрешение для Artisan на доступ Bluetooth отклонено</translation>
    </message>
    <message>
        <source>Bluetooth access denied</source>
        <translation type="vanished">Доступ по Bluetooth запрещен</translation>
    </message>
</context><context>
    <name>Plus</name>
    <message>
    ...
    <message>
        ...
        <translation>Сухой аромат</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически продлевать временную шкалу по мере необходимости</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Планирование на основе квадратичной регрессии трех точек</translation>
    </message>
    <message>
...
или выбранный исходный сигнал фоновых профилей</translation>
    ...
    <message>
        ...
        <translation>Фильтр на SV в режиме фонового слежения</translation>
    </message>
    <message>
        ...
        <translation>Сглаживание конечного выходного сигнала и подавление резких изменений в члене P/I</translation>
    </message>
    <message>
...
Этот диапазон можно ограничить, установив более жесткие минимальный и максимальный пределы.</translation>
    ...
    <message>
        ...
        <translation>Производная по измерению (предотвращение скачка производной)</translation>
    </message>
    <message>
        <location filename="../artisanlib/pid_dialogs.py" line="701" />
        <source>Integral limit factor</source>
        <translation>Интегральный предельный коэффициент</translation>
    </message>
    <message>
        <location filename="../artisanlib/pid_dialogs.py" line="709" />
        <source>Derivative limit</source>
        <translation>Производный предел</translation>
    </message>
    <message>
        ...
        <translation>Интегральный сброс при изменении цели (SP) превышает предел</translation>
    </message>
    <message>
        <location filename="../artisanlib/pid_dialogs.py" line="728" />
        <source>Integral Windup Prevention</source>
        <translation>Интегральная система предотвращения закручивания</translation>
    </message>
    <message>
...
has to be reduced by 4 times.</source>
        <translation>Применяет закон Бернулли к значениям, вычисленным
путём применения заданного коэффициента и смещения к значению ползунка,
предполагая, что контролируется давление газа, а не его расход.
Чтобы уменьшить тепло (или расход газа) на 50%, давление газа
...
specified by the lookahead</source>
        <translation>При линейном изменении значение линейного изменения берется с положительным временным смещением,
указанным опережающим просмотром</translation>
    </message>
    <message>
        ...
        <translation>Щелкните правой кнопкой мыши, чтобы редактировать</translation>
    </message>
    <message>
...
Unchecked: Fits a smooth spline to preserve curve shape.</source>
        <translation>В устаревшем режиме извлекаются только ключевые точки (CHARGE, DRY, FC, SC, DROP).
Не отмечено: применяется плавный сплайн для сохранения формы кривой.</translation>
    </message>
    <message>
        <location filename="../artisanlib/dialogs.py" line="798" />
        <source>Number of control points for spline fitting</source>
        <translation>Количество контрольных точек для подгонки сплайном</translation>
    </message>
    <message>
...
В настоящее время в ТЕМПЕРАТУРНОМ РЕЖИМЕ</translation>
    ...
    <message>
        ...
        <translation>Включить ПИД-регулирование</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сетевой IP-адрес или имя удаленного VirtualHub</translation>
    </message>
    <message>
        ...
        <translation>Получение события {} от машины</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Автоматически продлевать ось времени на 3 минуты при необходимости</translation>
    </message>
    <message>
        <source>Applies the Bernoulli's gas law to the values computed
by applying the given factor and offset to the slider value
...
To reduce heat (or gas flow) by 50% the gas pressure
has to be reduced by 4 times.</source>
        <translation type="vanished">Применяет газовый закон Бернулли к вычисленным значениям
