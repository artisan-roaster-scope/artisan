...
قم بتحميل ملف التعريف المسجل على الجهاز الأصغر وافتح Transposer. حدد التعيين الخطي وضع درجات الحرارة المستهدفة DRY و FC START كما هو ملاحظ على جهازك الأكبر في الحقول المقابلة تحت BT. أسفل الجدول ، ترى الصيغة الرمزية المحسوبة التي يمكن نسخها ولصقها في الصيغة الرمزية BT ضمن التكوين &gt;&gt; الأجهزة لضبط التعيين المحسوب تلقائيًا أثناء التحميص على جهازك الأصغر لرؤية قراءة درجة الحرارة كما تتوقعها على الجهاز الأكبر .</translation>
    ...
    <message>
        ...
        <translation>ملاحظة: سيتم استبدال العناصر النائبة {ET} و{BT} و{time} و{ETB} و{BTB} و{WEIGHTin} و{TEMP} بـ ET وBT والوقت وخلفية ET وقيمة خلفية BT وحجم الدفعة (بالجرام) وقيمة الحدث بالفولتية المحولة إلى وحدة درجة الحرارة الحالية في أوامر Serial/Artisan/CallProgram/MODBUS/S7/WebSocket
</translation>
    </message>
    <message>
        <location filename="../help/eventsliders_help.py" line="34"/>
...
يسمح استخدام المعادلات الرياضية في الراسم أيضًا باستخدام المتغيرات الرمزية P و F (انظر الإشارات والتعيينات الرمزية والرسام).</translation>
    ...
    <message>
        ...
        <translation type="vanished">ملاحظة: سيتم استبدال العناصر النائبة {ET}، و{BT}، و{time}، و{ETB}، و{BTB}، و{WEIGHTin} بـ ET، وBT، والوقت الحالي، وخلفية ET، وقيمة خلفية BT، وحجم الدفعة. (ز) في أوامر Serial/Artisan/CallProgram/MODBUS/S7/WebSocket
</translation>
    </message>
    <message>
        <source>Note: The placeholders {ET}, {BT}, {time}, {ETB}, {BTB}, and {WEIGHTin} will be substituted by the current ET, BT, time, ET background, BT background value and batch size (in g) in Serial/Artisan/CallProgram/MODBUS/S7/WebSocket commands
