...
class TestKaleidoImplementationDetails:
    ...
    def test_timeout_constants_from_source_inspection(self) -> None:
        ...
        assert 'self._ping_timeout:Final[float] = 1.2    # in seconds' in source_content
        assert 'self._send_timeout:Final[float] = 0.6    # in seconds' in source_content
        assert 'self._read_timeout:Final[float] = 5      # in seconds' in source_content
        assert 'self._ping_retry_delay:Final[float] = 1  # in seconds' in source_content
        assert 'self._reconnect_delay:Final[float] = 0.5 # in seconds' in source_content
