...
class Ui_setMeasureDialog(object):
    def setupUi(self, setMeasureDialog):
        ...
        setMeasureDialog.resize(259, 163)
        ...
        self.loadAduration = QtWidgets.QLabel(self.groupBox)
        self.loadAduration.setToolTip("")
        self.loadAduration.setAccessibleDescription("")
        self.loadAduration.setText("")
        self.loadAduration.setObjectName("loadAduration")
        self.gridLayout.addWidget(self.loadAduration, 0, 3, 1, 1)
        self.loadBduration = QtWidgets.QLabel(self.groupBox)
        self.loadBduration.setToolTip("")
        self.loadBduration.setAccessibleDescription("")
        self.loadBduration.setText("")
        self.loadBduration.setObjectName("loadBduration")
        self.gridLayout.addWidget(self.loadBduration, 1, 3, 1, 1)
        self.loadCduration = QtWidgets.QLabel(self.groupBox)
        self.loadCduration.setToolTip("")
        self.loadCduration.setAccessibleDescription("")
        self.loadCduration.setText("")
        self.loadCduration.setObjectName("loadCduration")
        self.gridLayout.addWidget(self.loadCduration, 2, 3, 1, 1)
        self.loadDduration = QtWidgets.QLabel(self.groupBox)
        self.loadDduration.setToolTip("")
        self.loadDduration.setAccessibleDescription("")
        self.loadDduration.setText("")
        self.loadDduration.setObjectName("loadDduration")
        self.gridLayout.addWidget(self.loadDduration, 3, 3, 1, 1)
