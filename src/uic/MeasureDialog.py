...
# Form implementation generated from reading ui file 'MeasureDialog.ui'
#
...
class Ui_setMeasureDialog(object):
    def setupUi(self, setMeasureDialog):
        ...
        self.notused1 = QtWidgets.QLabel(self.groupBox)
        self.notused1.setToolTip("")
        self.notused1.setAccessibleDescription("")
        self.notused1.setText("")
        self.notused1.setObjectName("notused1")
        self.gridLayout.addWidget(self.notused1, 4, 2, 1, 1)
