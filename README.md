...
|---------|------|---------|
| v1.0.0 | XX.XX.XXXX | Adds internal software PID, external MODBUS PID control, Apollo DT301, Extech 755, fast MODBUS RTU, AUC, bug fixes and stability improvements |
