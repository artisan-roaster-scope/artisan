...
| [v2.4.4](https://github.com/artisan-roaster-scope/artisan/releases/tag/v2.4.4)  | Dec 14, 2020 | Adds machine setups for the [Nordic PLC](https://artisan-scope.org/machines/nordic/), [Fabrica Roasters](https://artisan-scope.org/machines/fabrica/) and [MCR Series in C](https://artisan-scope.org/machines/mcr/), importers for [Rubasse](https://rubasseroasters.com/) and [Aillio](https://aillio.com/) RoastWorld, as well as PID Ramp/Soak pattern actions and templates (last version supporting Raspbian Stretch) |
