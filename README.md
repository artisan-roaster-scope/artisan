...
|---------|------:|---------|
| v2.1.0  | xx.11.2019 | Adds curve analyzer, extended symbolic formulas, forward looking alarms, more large LCDs, alarms triggered by temperature differences, 
support for the [Atilla](https://www.atilla.com.br/) GOLD_plus_7'' II,
