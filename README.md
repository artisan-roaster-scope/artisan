...
|---------|------:|---------|
| v2.1.0  | xx.11.2019 | Adds curve analyzer, extended symbolic formulas, forward looking alarms, more large LCDs, support to for the [Besca Bee sample roaster](https://www.bescaroasters.com/roaster-detail/14/Sample-Roasters/Besca-Bee-Coffee-Roaster), an extended [Coffeetool Rxx](https://coffeetool.gr/product-category/coffeeroasters/) machine setup that allows to control those machines, and popular Phidgets machine setups (incl. the one feature in [On Idle Noise](https://artisan-roasterscope.blogspot.com/2019/03/on-idle-noise.html)) |
